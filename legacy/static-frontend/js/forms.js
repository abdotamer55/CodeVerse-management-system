    ...
    document.querySelectorAll("[data-demo]").forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        document.getElementById("identifier").value =
          type === "student" ? "demo.student@codeverse.edu" : "demo.lead@codeverse.edu";
        document.getElementById("password").value =
          type === "student" ? "Student2025!Pass" : "Admin2025!Secure";
      });
    });
    ...
    if (loginForm) {
      loginForm.addEventListener("submit", (event) => {
        ...
        setTimeout(() => {
          ...
          window.location.href = role === "staff" ? `${root}admin/dashboard.html` : `${root}student/dashboard.html`;
        }, 900);
      });
    }
  }
